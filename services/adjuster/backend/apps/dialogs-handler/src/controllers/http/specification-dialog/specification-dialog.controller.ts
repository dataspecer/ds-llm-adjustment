...
export class SpecificationDialogController {
  ...
  public async processDefinitions(
    ...
    const result = await this._specificationProcessorService.processDefinitions(
      psmContent,
      oldApiContent,
      newApiContent,
      action,
  ...
  public async processDifference(
    ...
    const result = await this._specificationProcessorService.processSchemaDifferences(
      oldApiContent,
      newApiContent,
      psmContent
    );
